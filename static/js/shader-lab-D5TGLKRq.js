...
}`}];function V(a){const o=I.find(l=>l.name===a);o&&(x.value=o.source,D())}function D(){e&&(p.value=!0,f.value="",d.value={text:"",type:"info"},ee(()=>{const a=e.createShader(e.VERTEX_SHADER);e.shaderSource(a,_e),e.compileShader(a);const o=e.createShader(e.FRAGMENT_SHADER);if(e.shaderSource(o,x.value),e.compileShader(o),!e.getShaderParameter(o,e.COMPILE_STATUS)){f.value=e.getShaderInfoLog(o),d.value={text:"编译失败",type:"danger"},e.deleteShader(a),e.deleteShader(o),p.value=!1;return}const l=e.createProgram();if(e.attachShader(l,a),e.attachShader(l,o),e.linkProgram(l),!e.getProgramParameter(l,e.LINK_STATUS)){f.value=e.getProgramInfoLog(l),d.value={text:"链接失败",type:"danger"},p.value=!1;return}i&&e.deleteProgram(i),i=l;const k=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,k),e.bufferData(e.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),e.STATIC_DRAW);const h=e.getAttribLocation(i,"position");e.enableVertexAttribArray(h),e.vertexAttribPointer(h,2,e.FLOAT,!1,0,0),d.value={text:"编译成功",type:"success"},p.value=!1,P=performance.now()}))}function Y(){V(S.value)}function N(){c.value&&(c.value.width=_.value,c.value.height=_.value,e&&e.viewport(0,0,_.value,_.value))}function q(a){const o=c.value.getBoundingClientRect();B=(a.clientX-o.left)/o.width,E=1-(a.clientY-o.top)/o.height}function z(){if(!e||!i){y=requestAnimationFrame(z);return}e.useProgram(i),e.uniform1f(e.getUniformLocation(i,"u_time"),(performance.now()-P)/1e3*F.value),e.uniform2f(e.getUniformLocation(i,"u_resolution"),c.value.width,c.value.height),e.uniform2f(e.getUniformLocation(i,"u_mouse"),B,E),e.drawArrays(e.TRIANGLE_STRIP,0,4),A++;const a=performance.now();a-R>=1e3&&(L.value=A,A=0,R=a),y=requestAnimationFrame(z)}return W(()=>{const a=c.value;if(a){if(e=a.getContext("webgl")||a.getContext("experimental-webgl"),!e){f.value="您的浏览器不支持 WebGL";return}N(),V("plasma"),z()}}),j(()=>{y&&cancelAnimationFrame(y)}),(a,o)=>{const l=v("el-icon"),k=v("el-radio-button"),h=v("el-radio-group"),G=v("el-button"),X=v("el-tag"),U=v("el-option"),H=v("el-select"),K=v("el-slider");return m(),T("div",oe,[t("div",te,[t("div",ae,[t("div",le,[n(l,null,{default:s(()=>[(m(),g(b("color")))]),_:1}),o[4]||(o[4]=t("span",null,"GLSL 着色器编辑器",-1))]),t("div",ne,[n(h,{modelValue:S.value,"onUpdate:modelValue":o[0]||(o[0]=r=>S.value=r),size:"small",onChange:V},{default:s(()=>[(m(),T(J,null,Q(I,r=>n(k,{key:r.name,label:r.name},{default:s(()=>[w(C(r.label),1)]),_:2},1032,["label"])),64))]),_:1},8,["modelValue"])]),Z(t("textarea",{"onUpdate:modelValue":o[1]||(o[1]=r=>x.value=r),class:"code-editor",spellcheck:"false"},null,512),[[$,x.value]]),t("div",re,[n(G,{type:"primary",onClick:D,loading:p.value,size:"small"},{default:s(()=>[n(l,null,{default:s(()=>[(m(),g(b("video-play")))]),_:1}),o[5]||(o[5]=w("编译运行 ",-1))]),_:1},8,["loading"]),n(G,{onClick:Y,size:"small"},{default:s(()=>[n(l,null,{default:s(()=>[(m(),g(b("refresh-right")))]),_:1}),o[6]||(o[6]=w("重置 ",-1))]),_:1}),d.value.text?(m(),g(X,{key:0,type:d.value.type,size:"small"},{default:s(()=>[w(C(d.value.text),1)]),_:1},8,["type"])):M("",!0)]),f.value?(m(),T("div",se,[t("pre",null,C(f.value),1)])):M("",!0)]),t("div",ie,[t("div",ue,[n(l,null,{default:s(()=>[(m(),g(b("monitor")))]),_:1}),o[7]||(o[7]=t("span",null,"渲染预览",-1)),t("div",ce,C(L.value)+" FPS",1)]),t("div",ve,[t("canvas",{ref_key:"glCanvas",ref:c,onClick:q},null,512)]),t("div",me,[t("div",de,[o[8]||(o[8]=t("span",{class:"label"},"分辨率",-1)),n(H,{modelValue:_.value,"onUpdate:modelValue":o[2]||(o[2]=r=>_.value=r),size:"small",onChange:N,style:{width:"120px"}},{default:s(()=>[n(U,{label:"512×512",value:512}),n(U,{label:"768×768",value:768}),n(U,{label:"1024×1024",value:1024})]),_:1},8,["modelValue"])]),t("div",fe,[o[9]||(o[9]=t("span",{class:"label"},"速度",-1)),n(K,{modelValue:F.value,"onUpdate:modelValue":o[3]||(o[3]=r=>F.value=r),min:.1,max:3,step:.1},null,8,["modelValue"])])])])])])}}},ye=O(pe,[["__scopeId","data-v-2da1a499"]]);export{ye as default};
